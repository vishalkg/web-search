...
def search_startpage(query: str, num_results: int) -> List[Dict[str, Any]]:
    ...
    return search_engine_base(url, parse_startpage_results, "Startpage", query, num_results)


def search_duckduckgo(query: str, num_results: int) -> List[Dict[str, Any]]:
    """Search DuckDuckGo"""
    url = f"https://html.duckduckgo.com/html/?q={quote_plus(query)}"
    return search_engine_base(url, parse_duckduckgo_results, "DuckDuckGo", query, num_results)
